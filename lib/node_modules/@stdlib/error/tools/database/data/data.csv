...
"Jt","invalid argument. Third argument must be an array of integers. Value: `%s`.","TypeError"
"Ju","invalid option. `%s` option must be a negative integer. Option: `%s`.","TypeError"
"Jv","invalid argument. Specified dimension index is out-of-bounds. Must be on the interval: [-%u, %u]. Value: `%d`.","RangeError"
"Jw","invalid arguments. Arrays must have the same number of dimensions (i.e., same rank). ndims(x) == %d. ndims(y) == %d. ndims(z) == %d. ndims(w) == %d.","Error"
